...
public class DelaunayTriangulation {
     ...
     */
    public DelaunayTriangulation(List<com.example.test_trianglify.trianglify.utilities.triangulator.Vector2D> pointSet, Presenter.TrianglifyGenerateListener listener) {
    ...
    private void legalizeEdge(com.example.test_trianglify.trianglify.utilities.triangulator.Triangle2D triangle, com.example.test_trianglify.trianglify.utilities.triangulator.Edge2D edge, com.example.test_trianglify.trianglify.utilities.triangulator.Vector2D newVertex) {
        final com.example.test_trianglify.trianglify.utilities.triangulator.Triangle2D neighbourTriangle = triangleSoup.findNeighbour(triangle, edge);
        ...
        if (neighbourTriangle != null && neighbourTriangle.isPointInCircumCircle(newVertex)) {
            ...
            final com.example.test_trianglify.trianglify.utilities.triangulator.Vector2D noneEdgeVertex = neighbourTriangle.getNoneEdgeVertex(edge);

            final com.example.test_trianglify.trianglify.utilities.triangulator.Triangle2D firstTriangle = new com.example.test_trianglify.trianglify.utilities.triangulator.Triangle2D(noneEdgeVertex, edge.a, newVertex);
            final com.example.test_trianglify.trianglify.utilities.triangulator.Triangle2D secondTriangle = new com.example.test_trianglify.trianglify.utilities.triangulator.Triangle2D(noneEdgeVertex, edge.b, newVertex);

            triangleSoup.add(firstTriangle);
            triangleSoup.add(secondTriangle);

            legalizeEdge(firstTriangle, new com.example.test_trianglify.trianglify.utilities.triangulator.Edge2D(noneEdgeVertex, edge.a), newVertex);
            legalizeEdge(secondTriangle, new com.example.test_trianglify.trianglify.utilities.triangulator.Edge2D(noneEdgeVertex, edge.b), newVertex);
